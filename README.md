...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 56e0827e-f43a-47ee-aecf-5499081ee1df
```

> `56e0827e-f43a-47ee-aecf-5499081ee1df` is the password of the certificate, you can change it to any password you want.
